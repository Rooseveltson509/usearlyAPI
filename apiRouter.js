...
const reportingCtrl = require('./routes/reportingCtrl');
...
exports.router = (function() {
    ...
    apiRouter.route('/user/admin/reportings/', cors(corsOption.corsOptionsDelegate)).get(reportingCtrl.getAllReportings);
    ...
    apiRouter.route('/user/tickets/', cors(corsOption.corsOptionsDelegate)).get(ticketCtrl.getAllTicketsByStore);
