...
module.exports = {
  async up(queryInterface) {
    ...
    if (!siteTypes || siteTypes.length === 0) {
      throw new Error(
        "Aucun SiteType trouvé. Assurez-vous que la table SiteTypes est peuplée."
      );
    }
    ...
    const bugCategories = [
      ...
      {
        name: "Connexion utilisateur impossible",
        siteTypeId: siteTypeMap["E-commerce"],
      },
      {
        name: "Recherche de produits défaillante",
        siteTypeId: siteTypeMap["E-commerce"],
      },
      {
        name: "Problème d’affichage des produits",
        siteTypeId: siteTypeMap["E-commerce"],
      },
      {
        name: "Erreurs lors de l’ajout au panier",
        siteTypeId: siteTypeMap["E-commerce"],
      },
      {
        name: "Bug sur les filtres de produits",
        siteTypeId: siteTypeMap["E-commerce"],
      },
      {
        name: "Problème avec les coupons ou réductions",
        siteTypeId: siteTypeMap["E-commerce"],
      },
      {
      ...
      // Blog
      {
        name: "Erreur d’affichage des articles",
        siteTypeId: siteTypeMap["Blog"],
      },
      {
        name: "Problème de publication de commentaire",
        siteTypeId: siteTypeMap["Blog"],
      },
      {
        name: "Erreur d’intégration de média",
        siteTypeId: siteTypeMap["Blog"],
      },
      {
        name: "Mauvaise gestion des balises SEO",
        siteTypeId: siteTypeMap["Blog"],
      },
      ...
      {
        name: "Erreur lors de la réponse à un sujet",
        siteTypeId: siteTypeMap["Forum"],
      },
      {
        name: "Bug sur le moteur de recherche",
        siteTypeId: siteTypeMap["Forum"],
      },
      { name: "Problème de modération", siteTypeId: siteTypeMap["Forum"] },
      { name: "Notification non reçue", siteTypeId: siteTypeMap["Forum"] },
      {
        name: "Erreurs dans la gestion des profils",
        siteTypeId: siteTypeMap["Forum"],
      },
      ...
      {
        name: "Erreur de calcul dans les rapports",
        siteTypeId: siteTypeMap["SaaS"],
      },
      { name: "Instabilité du serveur", siteTypeId: siteTypeMap["SaaS"] },

      // Portfolio
      {
        name: "Erreur d’affichage des projets",
        siteTypeId: siteTypeMap["Portfolio"],
      },
      {
        name: "Problème avec le formulaire de contact",
        siteTypeId: siteTypeMap["Portfolio"],
      },
      { name: "Mauvaise mise en page", siteTypeId: siteTypeMap["Portfolio"] },
      {
        name: "Images floues ou déformées",
        siteTypeId: siteTypeMap["Portfolio"],
      },
      {
        name: "Temps de chargement élevé",
      ...
      {
        name: "Erreur dans les transitions animées",
        siteTypeId: siteTypeMap["Portfolio"],
      },

      // Éducationnel
      {
        name: "Problème avec les quiz ou tests",
        siteTypeId: siteTypeMap["Éducatif"],
      },
      { name: "Erreur d’inscription", siteTypeId: siteTypeMap["Éducatif"] },
      { name: "Cours non accessible", siteTypeId: siteTypeMap["Éducatif"] },
      {
        name: "Problème avec les vidéos éducatives",
        siteTypeId: siteTypeMap["Éducatif"],
      },
      {
        name: "Données des étudiants mal affichées",
        siteTypeId: siteTypeMap["Éducatif"],
      },
    ];
